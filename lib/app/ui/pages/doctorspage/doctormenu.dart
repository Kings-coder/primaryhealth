...
class DoctorMenu extends StatefulWidget {
  ...
  const DoctorMenu({Key? key, required this.scaffoldKey, this.onPageSelected})
      : super(key: key);
...
class _DoctorMenuState extends State<DoctorMenu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/remote.svg', title: "Patient Appointment List"),
    // MenuModel(icon: 'assets/svg/share-2.svg', title: "Patient on medication"),
